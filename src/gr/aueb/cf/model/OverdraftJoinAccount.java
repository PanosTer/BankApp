...
public class OverdraftJoinAccount extends JointAccount{
    public OverdraftJoinAccount(){}

    public OverdraftJoinAccount(User holder, String iban, double balance, User secondHolder) {
